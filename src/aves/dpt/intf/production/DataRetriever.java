 ...
 * in the {@link src/main/resource/data/mappadatasrc.xml} for the 
 * {@link aves.dpt.intf.production.Factory} that 
 * manages how {@link aves.dpt.intf.production.MappaObject}s
...
public interface DataRetriever {
    ...
    /**
     * Sets the {@link aves.dpt.intf.production.MappaObject.MappaObjectType}
     * of data to retrieve
     * @param mappaObjectType 
     */
    void setDataType(MappaObjectType mappaObjectType);
     ...
     * {@link aves.dpt.intf.viewers.MappaViewer}.
     * 
     * @param name 
     */
